...
internal object ExpirationDateVerifier {
    fun verify(state: ExpirationDateState): String {
        var error = ""
    ...
    private fun checkEmpty(state: ExpirationDateState): String? {
    ...
    private fun checkIncomplete(state: ExpirationDateState): String? {
