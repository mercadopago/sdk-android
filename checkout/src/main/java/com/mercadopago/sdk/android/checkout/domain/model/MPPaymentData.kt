...
sealed class MPPaymentData {
     ...
     *
     * Order-based result delivered after processing an order. Offline payment methods
     * (e.g. boleto/ticket) additionally expose [barcodeContent] and [dateOfExpiration].
     *
     * @property orderId Identifier of the processed order.
     * @property orderStatus Status of the processed order.
     * @property barcodeContent Optional barcode content for offline payment methods.
     * @property dateOfExpiration Optional expiration date for offline payment methods.
     */
    data class Payment(
        val orderId: String,
        val orderStatus: String,
