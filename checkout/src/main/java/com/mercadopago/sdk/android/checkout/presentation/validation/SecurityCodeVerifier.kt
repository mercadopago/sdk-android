...
internal object SecurityCodeVerifier {
    fun verify(state: SecurityCodeState): String {
        var error = ""
    ...
    private fun checkEmpty(state: SecurityCodeState): String? {
    ...
    private fun checkIncomplete(state: SecurityCodeState): String? {
