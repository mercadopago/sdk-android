...
internal object IdentificationTypeVerifier {
    fun verify(state: IdentificationTypeState): String {
        var error = ""
    ...
    private fun checkEmpty(state: IdentificationTypeState): String? {
    ...
    private fun checkIncomplete(state: IdentificationTypeState): String? {
