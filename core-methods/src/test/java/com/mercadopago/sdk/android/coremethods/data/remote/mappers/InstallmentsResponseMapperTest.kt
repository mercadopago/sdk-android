...
internal class InstallmentsResponseMapperTest {
    ...
    fun `InstallmentsResponse toModel should convert correctly`() {
        ...
        assertEquals(1000f.toBigDecimal(), payerCostModel?.installmentAmount)
        assertEquals(1.5f, payerCostModel?.instalmentsRate)
        assertEquals(listOf("Collective 1"), payerCostModel?.installmentRateCollector)
        assertEquals(3000f.toBigDecimal(), payerCostModel?.totalAmount)
    ...
    fun `PayerCostResponse toModel should convert correctly`() {
        ...
        assertEquals(payerCostResponse.installmentAmount?.toBigDecimal(), model.installmentAmount)
        ...
        assertEquals(payerCostResponse.totalAmount?.toBigDecimal(), model.totalAmount)
